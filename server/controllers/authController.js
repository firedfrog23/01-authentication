...
export const sendResetOtp = async (req, res) => {
    ...
    try {
        ...
        const mailOption = {
            ...
            text: `Your OTP to reset your password is ${otp}. Reset your password using this OTP.`
        }

        await transporter.sendMail(mailOption);

        return res.json({ success: true, message: `OTP has been sent to your e-mail` })
